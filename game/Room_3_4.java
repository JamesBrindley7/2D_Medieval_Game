...
class Room_3_4 extends Room {
     ...
     */
    Room_3_4(RenderWindow window, KeyboardHandler kh, Level level) throws IOException {
        ...
        testGuard[0] = new GuardSword(window, 200, 300, this);
        testGuard[1] = new GuardSword(window, 900, 300, this);
        player = new Player(window, 600, 500, testGuard, this);
        key = new Key(window, player, 600, 350, this, 2, "UP");
    ...
    void currentRoomLoop() throws IOException {
        while (window.isOpen() && (currentRoom)) {
            ...
            testGuard[0].patrolBox(200, 900, 301, 301);
            testGuard[1].patrolBox(200, 900, 300, 301);
