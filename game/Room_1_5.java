...
class Room_1_5 extends Room {
     ...
     */
    Room_1_5(RenderWindow window, KeyboardHandler kh, Level level) throws IOException {
        ...
        Path path = Paths.get("sprites/Room_v2_Door_Left.png");
        ...
        wasd = new Text("Fire the Bow with (1).", font, 64);
