...
class Room_2_7 extends Room {
     ...
     */
    Room_2_7(RenderWindow window, KeyboardHandler kh, Level level) throws IOException {
        ...
        Path path = Paths.get("sprites/Room_v2_Door_Right_Door_Down.png");
