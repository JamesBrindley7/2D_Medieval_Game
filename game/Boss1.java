...
public class Boss1 extends Boss {
    ...
    private static int health = 200;	//Boss Health
    ...
    private static int primaryattackspeed = 50;
    private static int secondaryattackspeed = 60;
    ...
    private static String enemyname = "Boss1";
    
    RenderWindow window;

    private Room room;
    
	public Boss1(RenderWindow window, int xPosition, int yPosition, Room room) throws IOException {
