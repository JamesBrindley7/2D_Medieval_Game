...
class Room_2_4 extends Room {
     ...
     */
    Room_2_4(RenderWindow window, KeyboardHandler kh, Level level) throws IOException {
        ...
        testGuard[1] = new GuardSword(window, 600, 400, this);
    ...
    void currentRoomLoop() throws IOException {
        while (window.isOpen() && (currentRoom)) {
            ...
            testGuard[1].patrolBox(600, 600, 300, 400);
