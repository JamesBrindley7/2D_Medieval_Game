...
class Room_2_0 extends Room {
     ...
     */
    Room_2_0(RenderWindow window, KeyboardHandler kh, Level level) throws IOException {
        ...
        Path path = Paths.get("sprites/Room_v2_Door_Left_Unlocked_Right_Locked.png");
        Path path2 = Paths.get("sprites/Room_v2_Door_Left_Unlocked_Right_Unlocked.png");
