...
class Room_2_6 extends Room {
     ...
     */
    Room_2_6(RenderWindow window, KeyboardHandler kh, Level level) throws IOException {
        ...
        wasd = new Text("Blocks can be pulled with E.", font, 64);
        ...
        Box[0] = new MovableBox(window, 1000, 500, 80, 80, player);
        pressurePlate = new PressurePlate(window, player, 1000, 150, Box[0], this, 5, "LEFT");
