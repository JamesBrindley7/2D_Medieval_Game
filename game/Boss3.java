...
public class Boss3 extends Boss {
	...
	private static int attackdistance = 200;	//Attacking distance
	...
	private static int health = 1500;	//Boss Health
	...
	private static int primaryattackspeed = 30;
	private static int secondaryattackspeed = 40;
	private static int tertiaryattackspeed = 70;
	...
	private static String enemyname = "Boss3";

	RenderWindow window;

	private Room room;

	public Boss3(RenderWindow window, int xPosition, int yPosition, Room room) throws IOException {
