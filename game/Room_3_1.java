...
class Room_3_1 extends Room {
     ...
     */
    Room_3_1(RenderWindow window, KeyboardHandler kh, Level level) throws IOException {
        ...
        Path path = Paths.get("sprites/Room_v2_Door_Right_Door_Up.png");
        ...
        testGuard[1] = new GuardSword(window, 1000, 350, this);
        testGuard[2] = new GuardSword(window, 200, 500, this);
    ...
    void currentRoomLoop() throws IOException {
        while (window.isOpen() && (currentRoom)) {
            ...
            testGuard[1].patrolBox(200, 1000, 350, 351);
            testGuard[2].patrolBox(200, 1000, 500, 501);
