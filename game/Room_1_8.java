...
class Room_1_8 extends Room {
     ...
     */
    Room_1_8(RenderWindow window, KeyboardHandler kh, Level level) throws IOException {
        ...
        bossName = new Text("Guard Boss", font, 48);
        ...
        boss = new Boss1(window, 600, 500, this);
    ...
    void currentRoomLoop() throws IOException {
        while (window.isOpen() && (currentRoom)) {
            ...
            bossHealth.setSize(new Vector2f(boss.getStats().getHealth()*5, 25));
