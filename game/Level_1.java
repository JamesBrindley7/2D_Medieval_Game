...
class Level_1 extends Level {
    ...
    private boolean playerHasBow = false;

    Level_1(RenderWindow window, KeyboardHandler kh) throws IOException {
        super(window, kh);
        levelNum = 1;
         ...
         */
        rooms[0] = new Room_1_0(window, kh, this);
        rooms[1] = new Room_1_1(window, kh, this);
        rooms[2] = new Room_1_2(window, kh, this);
        rooms[3] = new Room_1_3(window, kh, this);
        rooms[4] = new Room_1_4(window, kh, this);
        rooms[5] = new Room_1_5(window, kh, this);
        rooms[6] = new Room_1_6(window, kh, this);
        rooms[7] = new Room_1_7(window, kh, this);
        rooms[8] = new Room_1_8(window, kh, this);
